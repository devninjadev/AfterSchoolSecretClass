...
Maintain substantial but persona-specific primary-source registries. Hayoung's signature quotation canon is Stanley Druckenmiller and George Soros, supported by Soros's own essays and lectures and a primary Druckenmiller speech or interview transcript. Myunghee's signature quotation canon is Warren Buffett and Ray Dalio, supported by Berkshire shareholder letters and SEC filings and Dalio's official Principles publications. General education or regulatory references remain a separate evidence layer and do not redefine either persona's signature voices. Myunghee's professional-planning layer additionally includes FPSB standards and Korean official sources for tax, pensions, retirement plans, health insurance, financial consumer protection, insurance, and statutes. A registry entry records the source role and the type of claim it can support; it is not a license to treat old material as current.

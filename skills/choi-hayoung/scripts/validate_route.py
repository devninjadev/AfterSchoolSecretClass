#!/usr/bin/env python3
"""Validate a closed Hayoung LLM-routing object read from standard input."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Validate a closed Hayoung route JSON object from stdin")
    parser.add_argument(
        "--safe-default",
        action="store_true",
